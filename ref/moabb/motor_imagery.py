...
""" Code originally from: https://github.com/NeuroTechX/moabb/blob/develop/moabb/paradigms/motor_imagery.py"""
...
from moabb_paradigm.base import BaseParadigm # XXX Change from the original code: importing the local version of the base class
